...
2. **Сравни:**
   ...
   - Какие модули стали новой системой (несколько связанных файлов в одной папке) — создать `architecture/<system>.md` из `.codex/kit/templates/architecture-system-template.md`
...
- Если PROJECT_MAP.md / ARCHITECTURE.md не существуют — создай из шаблонов в `.codex/kit/templates/`.
